...
import { GetBootstrapResponseSchema, WorkspaceService, } from "../contracts/tank/workspace/v1/workspace_pb.js";
...
export class TankClient {
    ...
    async start() {
        ...
        this.realtime.start();
        this.typingSweep = setInterval(() => this.store.dispatch({ type: "typing/expire", now: this.now() }), 1_000);
